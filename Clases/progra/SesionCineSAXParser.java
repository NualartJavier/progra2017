...
// Flag que indica si estamos parseando el contenido de texto a sesion
    ...
    public void endElement(String namespaceURI,
        ...
        if (qName.equals("Pelicula")) {
            ...
            this.sesionesPeliculas.add(new SesionesPelicula(pelicula, this.sesionesStrPelicula));
        } else if (qName.equals("Sesion")) {
